...
function OtherKIP17({ list, nftName, openDetails }) {
    ...
    const handleImgError = (e) => {
        //console.log(e)
        e.target.src = `/image/otherProject/KlayMojis.png`
    }
        ...
        <>
            {
                list.meta?.map(function (a, index) {
                    return (
                        <div key={index} className="NFTBox_min neonShine" onClick={() => openDetails(list, a, index)}
